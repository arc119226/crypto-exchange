...
export const en = {
  ...
  'wallet.amount_label': 'Amount (min {min} {asset})',
  'wallet.fee_rate': 'Fee: {fee} {asset} + {bps} bps, charged on top of the amount.',
  'wallet.fee_total': 'Fee {fee} {asset}; {total} {asset} leaves your balance.',
...
export const zhTW: Record<Key, string> = {
  ...
  'wallet.amount': '金額',
  'wallet.amount_label': '金額(最少 {min} {asset})',
  'wallet.fee_rate': '手續費:{fee} {asset} 加上 {bps} 個基點,額外加收。',
  'wallet.fee_total': '手續費 {fee} {asset};帳戶會扣 {total} {asset}。',
