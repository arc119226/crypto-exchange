...
- **從哪裡複製會影響對錯。** 有些顯示方式會幫 markdown 的特殊字元加跳脫:行尾 `\` 變成 `\\`、`_` 變成 `\_`。貼進終端機前掃一眼有沒有這種多餘的反斜線。最保險是直接從 repo 裡的 `docs/guides/sepolia.md` 複製。
...
### 上一趟實跑的完整紀錄(2026-09,Sepolia)

**這是 §12 Phase 4 DoD 的「Sepolia runbook 含 tx hash 記錄」。** 七筆都在 Sepolia 上,
`sepolia.etherscan.io/tx/<hash>` 查得到,任何人都可以自己驗一遍。

| 步驟 | tx hash | 區塊 | gas used | effective gas price (wei) | 成本 (ETH) |
|---|---|---|---|---|---|
| ETH 充值(faucet → 充值地址) | `0x835a0ea9900e5eb0bd6eaaffe12d9b7dbb4ace396824c87161c286c2ef7be677` | 11653761 | 21000 | 2976607021 | 0.000062509 |
| USDC 充值(mint → 充值地址) | `0x4810dbc580b7dba514f790bc1cdebfcb161844dbe1b2b15e70e2c943234066b6` | 11653755 | 51178 | 1036951043 | 0.000053069 |
| ETH 歸集 | `0x22618e1fe7643b57e7d3692451cbb669e7fd4802974b0aff9fe97db58bcae1d1` | 11653781 | 21000 | 1093039631 | 0.000022954 |
| USDC 歸集:補 gas | `0xb6d93a2182d8d10423e2e454d4f333a7d82931de2fcbfee84c067ab7275d8d15` | 11653801 | 21000 | 1115331713 | 0.000023422 |
| USDC 歸集:轉帳 | `0x78e6a19534f2075e3c38417b974dfc0846b9f7d367a911abe277c7623c6ad774` | 11653820 | 29669 | 1004988799 | 0.000029817 |
| 提現(自動核可) | `0x5ad7dd15a8eebfc57ec081a36a1f94b49a9cd0c5072ac49faded7f30a88f9d34` | 11653923 | 21000 | 1060107175 | 0.000022262 |
| 提現(人工審核) | `0xaa679cb2f99a9f74769b84a802eb97f08b2db3d69543178adad34de9718b8d29` | 11653944 | 21000 | 1100875823 | 0.000023118 |

> **faucet 給熱錢包那筆不在表裡**,因為它發生在交易所外面,系統從來沒看過它。
> 這不是遺漏,是「交易所只記得自己經手的東西」這件事的直接後果。

**這張表是有用的,不只是紀錄。** `docs/domain.md §22.6` 原本寫錯了歸集競態的機制,
更正它靠的就是這裡的區塊順序:ETH 歸集在 11653781,唯一那筆補 gas 在 11653801(晚 20 個區塊),
所以補 gas 屬於重新規劃後的那筆,不是失敗的那筆。**沒有這張表,那個更正就沒有人能驗證。**

你自己跑完之後,`scripts/sepolia-results.sh` 會產生同樣格式的表格,可以跟這一趟對照。
