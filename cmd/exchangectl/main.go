...
func newRootCmd() *cobra.Command {
	...
	root.AddCommand(newMarketsCmd(), newAssetsCmd(), newReplayCmd(), newAdminCmd(),
		newUserCmd(), newAPIKeysCmd(), newOrdersCmd(), newBalancesCmd(), newDepositAddressCmd(), newDepositsCmd(), newWithdrawalsCmd(), newFillsCmd(), newBookCmd(), newTradesCmd(), newE2ECmd())
